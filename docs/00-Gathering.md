Chatto con copilot o chatgpt o con qualsiasi cosa che sia forte, e faccio come prima cosa un deep research, ad esempio cerco altre app simili, o tutta la parte di documentazione microsoft che mi manca, o una combo di informazioni che reputo sensate per l'applicativo.
...
Ora gli dico di crearmi un prompt da quanto ho scritto sopra, per fare la deep research in maniera migliore.
Così ottengo:
...
E via con la deep research o resercher o altro.
