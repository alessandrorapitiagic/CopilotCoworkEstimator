...
export const DEFAULT_TOUR_STEPS: TourStep[] = [
  ...
  { target: 'nav-profiles', titleKey: 'tour.profiles.title', bodyKey: 'tour.profiles.body' },
  { target: 'profiles-list', titleKey: 'tour.profilesList.title', bodyKey: 'tour.profilesList.body' },
  { target: 'assumptions-tabs', titleKey: 'tour.assumptionsTabs.title', bodyKey: 'tour.assumptionsTabs.body' },
  { target: 'tasks-list', titleKey: 'tour.tasksList.title', bodyKey: 'tour.tasksList.body' },
  { target: 'models-list', titleKey: 'tour.modelsList.title', bodyKey: 'tour.modelsList.body' },
